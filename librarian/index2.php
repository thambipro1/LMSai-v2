    ...
    <div style="background-color: #f8f9fa; border-radius: 10px; padding: 30px; box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.2); animation: fadeIn 1.5s;">
        ...
        <form method="POST">
            <div style="margin-bottom: 15px;">
                <label for="username" style="display: block; font-weight: bold; color: #555;">Student ID</label>
        ...
        if (isset($_POST['submit'])) {
            ...
            $stmt = $db->prepare("SELECT student_no, photo FROM students WHERE student_no = ? AND password = ?");
